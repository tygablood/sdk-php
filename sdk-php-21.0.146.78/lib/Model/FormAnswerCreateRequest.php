...
/**
 * FormAnswerCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FormAnswerCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FormAnswerCreateRequest';
    ...
    protected static $openAPIFormats = [
        'key' => null,
        'value' => 'string(date-time) | number | string | string(OptionId) | string(DataUrl) | string(OptionId)[] | string(uuid)(MediaId)[]'
    ];
