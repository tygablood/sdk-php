...
/**
 * FormCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FormCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FormCreateRequest';
    ...
    protected static $openAPITypes = [
        'groups' => '\OpenAPI\Client\Model\FormGroupCreateRequest[]',
        'template_id' => 'string'
    ];
     ...
     * Gets groups
     *
     * @return \OpenAPI\Client\Model\FormGroupCreateRequest[]
     */
     ...
     * Sets groups
     *
     * @param \OpenAPI\Client\Model\FormGroupCreateRequest[] $groups The groups of answers
     *
     * @return self
     */
    public function setGroups($groups)
    {
        ...
        if ((count($groups) < 1)) {
            throw new \InvalidArgumentException('invalid length for $groups when calling FormCreateRequest., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets template_id
     *
     * @param string $template_id The form template id
     *
     * @return self
     */
