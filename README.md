...
*PropertyApi* | [**getPropertyTemplatesReports**](docs/Api/PropertyApi.md#getpropertytemplatesreports) | **GET** /property/templates/reports | Get all available report templates
*PropertyApi* | [**propertyTemplatesClaimsClaimTemplateIdReportsGet**](docs/Api/PropertyApi.md#propertytemplatesclaimsclaimtemplateidreportsget) | **GET** /property/templates/claims/{claim-template-id}/reports | Get all report templates for the claim template
...
*PropertyClaimsApi* | [**createPropertyClaimReport**](docs/Api/PropertyClaimsApi.md#createpropertyclaimreport) | **POST** /property/claim/{claim-id}/reports | Create a property claim report
*PropertyClaimsApi* | [**getPropertyClaimReportById**](docs/Api/PropertyClaimsApi.md#getpropertyclaimreportbyid) | **GET** /property/claim/{claim-id}/reports/{report-id} | Get a property claim report by id
*PropertyClaimsApi* | [**getPropertyClaimReports**](docs/Api/PropertyClaimsApi.md#getpropertyclaimreports) | **GET** /property/claim/{claim-id}/reports | Get property claim reports
...
*TemplatesApi* | [**getPropertyTemplatesReports**](docs/Api/TemplatesApi.md#getpropertytemplatesreports) | **GET** /property/templates/reports | Get all available report templates
*TemplatesApi* | [**getTemplates**](docs/Api/TemplatesApi.md#gettemplates) | **GET** /templates | Get available templates
*TemplatesApi* | [**propertyTemplatesClaimsClaimTemplateIdReportsGet**](docs/Api/TemplatesApi.md#propertytemplatesclaimsclaimtemplateidreportsget) | **GET** /property/templates/claims/{claim-template-id}/reports | Get all report templates for the claim template
...
## Documentation For Models
 ...
 - [DeprecatedTemplateMetadata](docs/Model/DeprecatedTemplateMetadata.md)
 ...
 - [PropertyClaimReportsRequestCreate](docs/Model/PropertyClaimReportsRequestCreate.md)
 - [PropertyClaimReportsResponse](docs/Model/PropertyClaimReportsResponse.md)
 ...
 - [TemplateMetadataOwner](docs/Model/TemplateMetadataOwner.md)
