...
/**
 * PropertyCoverageAdditionalCoverageMetadata Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PropertyCoverageAdditionalCoverageMetadata implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PropertyCoverageAdditionalCoverageMetadata';
     ...
     * Sets id
     *
     * @param string $id The id of the additional coverage
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The additional coverage name
     *
     * @return $this
     */
