 ...
 */
class AdHocCompanyStakeholderUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdHocCompanyStakeholderUpdateRequest';
