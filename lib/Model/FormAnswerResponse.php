...
/**
 * FormAnswerResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FormAnswerResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FormAnswerResponse';
    ...
    protected static $openAPIFormats = [
        'key' => null,
        'value' => 'string(date-time) | number | string | string(OptionId) | string(DataUrl) | string(OptionId)[] | object(MediaResponse)[]'
    ];
