...
class PropertyClaimPolicyInfo implements ModelInterface, ArrayAccess
{
     ...
     * Sets mortgagee
     *
     * @param string $mortgagee The name of the mortgage holder. This is required if `loanNumber` is provided.
     *
     * @return $this
     */
     ...
     * Sets loan_number
     *
     * @param string $loan_number The loan number of the mortgage. This is required if `mortgagee' is provided.
     *
     * @return $this
     */
