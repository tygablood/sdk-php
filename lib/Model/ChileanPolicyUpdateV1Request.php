 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ChileanPolicyUpdateV1Request implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChileanPolicyUpdateV1Request';
...
'country' => 'string',
'coverages' => '\Swagger\Client\Model\IChileanCoverageOrSublimitV1Request[]',
'currency' => 'string',
...
'risk_address' => 'getRiskAddress'    ];
     ...
     * Gets coverages
     *
     * @return \Swagger\Client\Model\IChileanCoverageOrSublimitV1Request[]
     */
     ...
     * Sets coverages
     *
     * @param \Swagger\Client\Model\IChileanCoverageOrSublimitV1Request[] $coverages coverages
     *
     * @return $this
     */
