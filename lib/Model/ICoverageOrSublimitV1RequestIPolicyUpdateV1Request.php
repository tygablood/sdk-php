...
/**
 * ICoverageOrSublimitV1RequestIPolicyUpdateV1Request Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ICoverageOrSublimitV1RequestIPolicyUpdateV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ICoverageOrSublimitV1RequestIPolicyUpdateV1Request';
    ...
    public function setCurrency($currency)
    {
        if (!is_null($currency) && (mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ICoverageOrSublimitV1RequestIPolicyUpdateV1Request., must be smaller than or equal to 3.');
        }
        if (!is_null($currency) && (mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ICoverageOrSublimitV1RequestIPolicyUpdateV1Request., must be bigger than or equal to 3.');
        }
