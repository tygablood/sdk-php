...
class FormResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'groups' => '\OpenAPI\Client\Model\FormGroupResponse[]',
        'id' => 'string',
        'template_id' => 'string'
    ];
     ...
     * Gets groups
     *
     * @return \OpenAPI\Client\Model\FormGroupResponse[]
     */
     ...
     * Sets groups
     *
     * @param \OpenAPI\Client\Model\FormGroupResponse[] $groups The groups of answers
     *
     * @return self
     */
