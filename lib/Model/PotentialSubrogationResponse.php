...
/**
 * PotentialSubrogationResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PotentialSubrogationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PotentialSubrogationResponse';
     ...
     * Sets explanation
     *
     * @param string $explanation The potential subrogation explanation
     *
     * @return self
     */
