...
/**
 * PerilMetadata1 Class Doc Comment
 *
 * @category Class
 * @description Describes a Peril
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PerilMetadata1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PerilMetadata_1';
     ...
     * Sets id
     *
     * @param string $id The id of the peril
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The peril name
     *
     * @return $this
     */
