...
class PolicyV1ResponseBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      * Array of discriminator to subtype mappings. Used for (de)serialization
      *
      * @var string[]
      */
      protected static $subTypes = [
        "AU" => 'AustralianPolicyV1Response',
        "CA" => 'CanadianPolicyV1Response',
        "CL" => 'ChileanPolicyV1Response',
        "FR" => 'FrenchPolicyV1Response',
        "MX" => 'MexicanPolicyV1Response',
        "UK" => 'BritishPolicyV1Response',
        "US" => 'AmericanPolicyV1Response'
    ];
    ...
    /**
     * Array of subtypes mappings.  Used for (de)serialization
     * 
     * @return array
     */
