...
/**
 * PropertyEstimateResponse1 Class Doc Comment
 *
 * @category Class
 * @description Confirms a property estimate was created
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PropertyEstimateResponse1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PropertyEstimateResponse_1';
     ...
     * Sets id
     *
     * @param string $id The id of the property estimate
     *
     * @return $this
     */
