 ...
 */
class GenericPolicyUpdateV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GenericPolicyUpdateV1Request';
    ...
    protected static $openAPITypes = [
        ...
        'country' => 'string',
        'coverages' => '\OpenAPI\Client\Model\IGenericCoverageOrSublimitV1Request[]',
        'currency' => 'string',
    ...
    public function setCountry($country)
    {
        if ((mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling GenericPolicyUpdateV1Request., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling GenericPolicyUpdateV1Request., must be bigger than or equal to 2.');
        }
     ...
     * Gets coverages
     *
     * @return \OpenAPI\Client\Model\IGenericCoverageOrSublimitV1Request[]|null
     */
     ...
     * Sets coverages
     *
     * @param \OpenAPI\Client\Model\IGenericCoverageOrSublimitV1Request[]|null $coverages coverages
     *
     * @return self
     */
    ...
    public function setCurrency($currency)
    {
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling GenericPolicyUpdateV1Request., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling GenericPolicyUpdateV1Request., must be bigger than or equal to 3.');
        }
