 ...
 */
class IChileanCoverageOrSublimitV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IChileanCoverageOrSublimitV1Request';
