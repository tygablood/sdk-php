...
/**
 * PolicyCreateRequestBase Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PolicyCreateRequestBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PolicyCreateRequestBase';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['policy_template_id'] === null) {
            $invalidProperties[] = "'policy_template_id' can't be null";
        }
    ...
    public function setCurrency($currency)
    {
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling PolicyCreateRequestBase., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling PolicyCreateRequestBase., must be bigger than or equal to 3.');
        }
