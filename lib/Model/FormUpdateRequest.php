...
/**
 * FormUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FormUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FormUpdateRequest';
    ...
    protected static $openAPITypes = [
        'groups' => '\OpenAPI\Client\Model\FormGroupUpdateRequest[]'
    ];
     ...
     * Gets groups
     *
     * @return \OpenAPI\Client\Model\FormGroupUpdateRequest[]
     */
     ...
     * Sets groups
     *
     * @param \OpenAPI\Client\Model\FormGroupUpdateRequest[] $groups The groups of answers
     *
     * @return self
     */
    public function setGroups($groups)
    {
        ...
        if ((count($groups) < 1)) {
            throw new \InvalidArgumentException('invalid length for $groups when calling FormUpdateRequest., number of items must be greater than or equal to 1.');
        }
