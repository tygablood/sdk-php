...
class FolderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
      protected static $subTypes = [
        FolderType::ROOM => 'RoomResponse',
        Foldertype::FOLDER => 'FolderResponse'
    ];
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\FolderType
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\FolderType $type type
     *
     * @return self
     */
     ...
     * Sets folder_id
     *
     * @param string|null $folder_id The id of the parent folder. Null if directly on the estimate.
     *
     * @return self
     */
