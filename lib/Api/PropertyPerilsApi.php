...
class PropertyPerilsApi
{
    ...
    /**
     * Operation propertyPoliciesPerilsPerilIdCausesOfLossGet
     *
     * Cause of loss
     *
     ...
     */
    public function propertyPoliciesPerilsPerilIdCausesOfLossGet($peril_id)
    {
        list($response) = $this->propertyPoliciesPerilsPerilIdCausesOfLossGetWithHttpInfo($peril_id);
        return $response;
    }

    /**
     * Operation propertyPoliciesPerilsPerilIdCausesOfLossGetWithHttpInfo
     *
     * Cause of loss
     *
     * @param  string $peril_id The id of the peril (required)
     ...
     */
    public function propertyPoliciesPerilsPerilIdCausesOfLossGetWithHttpInfo($peril_id)
    {
        $returnType = '\Swagger\Client\Model\CausesOfLoss';
        $request = $this->propertyPoliciesPerilsPerilIdCausesOfLossGetRequest($peril_id);
    ...
    /**
     * Operation propertyPoliciesPerilsPerilIdCausesOfLossGetAsync
     *
     * Cause of loss
     *
     * @param  string $peril_id The id of the peril (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function propertyPoliciesPerilsPerilIdCausesOfLossGetAsync($peril_id)
    {
        return $this->propertyPoliciesPerilsPerilIdCausesOfLossGetAsyncWithHttpInfo($peril_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation propertyPoliciesPerilsPerilIdCausesOfLossGetAsyncWithHttpInfo
     *
     * Cause of loss
     *
     * @param  string $peril_id The id of the peril (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function propertyPoliciesPerilsPerilIdCausesOfLossGetAsyncWithHttpInfo($peril_id)
    {
        $returnType = '\Swagger\Client\Model\CausesOfLoss';
        $request = $this->propertyPoliciesPerilsPerilIdCausesOfLossGetRequest($peril_id);
    ...
    /**
     * Create request for operation 'propertyPoliciesPerilsPerilIdCausesOfLossGet'
     *
     * @param  string $peril_id The id of the peril (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function propertyPoliciesPerilsPerilIdCausesOfLossGetRequest($peril_id)
    {
        // verify the required parameter 'peril_id' is set
        if ($peril_id === null || (is_array($peril_id) && count($peril_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $peril_id when calling propertyPoliciesPerilsPerilIdCausesOfLossGet'
            );
        }
