...
class PropertyClaimsApi
{
    ...
    /**
     * Operation createPropertyClaimReport
     *
     * Create a property claim report
     *
     * @param  string $claim_id claim_id (required)
     * @param  \Swagger\Client\Model\PropertyClaimReportsRequestCreate $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\PropertyClaimReportsResponse
     */
    public function createPropertyClaimReport($claim_id, $body)
    {
        list($response) = $this->createPropertyClaimReportWithHttpInfo($claim_id, $body);
        return $response;
    }

    /**
     * Operation createPropertyClaimReportWithHttpInfo
     *
     * Create a property claim report
     *
     * @param  string $claim_id (required)
     * @param  \Swagger\Client\Model\PropertyClaimReportsRequestCreate $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PropertyClaimReportsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPropertyClaimReportWithHttpInfo($claim_id, $body)
    {
        $returnType = '\Swagger\Client\Model\PropertyClaimReportsResponse';
        $request = $this->createPropertyClaimReportRequest($claim_id, $body);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\PropertyClaimReportsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation createPropertyClaimReportAsync
     *
     * Create a property claim report
     *
     * @param  string $claim_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPropertyClaimReportAsync($claim_id, $body)
    {
        return $this->createPropertyClaimReportAsyncWithHttpInfo($claim_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createPropertyClaimReportAsyncWithHttpInfo
     *
     * Create a property claim report
     *
     * @param  string $claim_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPropertyClaimReportAsyncWithHttpInfo($claim_id, $body)
    {
        $returnType = '\Swagger\Client\Model\PropertyClaimReportsResponse';
        $request = $this->createPropertyClaimReportRequest($claim_id, $body);
    ...
    /**
     * Create request for operation 'createPropertyClaimReport'
     *
     * @param  string $claim_id (required)
     * @param  \Swagger\Client\Model\PropertyClaimReportsRequestCreate $body (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createPropertyClaimReportRequest($claim_id, $body)
    {
        // verify the required parameter 'claim_id' is set
        if ($claim_id === null || (is_array($claim_id) && count($claim_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $claim_id when calling createPropertyClaimReport'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling createPropertyClaimReport'
            );
        }

        $resourcePath = '/property/claim/{claim-id}/reports';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getPropertyClaimReportById
     *
     ...
     * @return \Swagger\Client\Model\PropertyClaimReportsResponse
     */
    public function getPropertyClaimReportById($claim_id, $report_id)
    {
        list($response) = $this->getPropertyClaimReportByIdWithHttpInfo($claim_id, $report_id);
        return $response;
    }

    /**
     * Operation getPropertyClaimReportByIdWithHttpInfo
     *
     * Get a property claim report by id
     *
     * @param  string $claim_id (required)
     ...
     * @return array of \Swagger\Client\Model\PropertyClaimReportsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPropertyClaimReportByIdWithHttpInfo($claim_id, $report_id)
    {
        $returnType = '\Swagger\Client\Model\PropertyClaimReportsResponse';
        $request = $this->getPropertyClaimReportByIdRequest($claim_id, $report_id);
    ...
    /**
     * Operation getPropertyClaimReportByIdAsync
     *
     * Get a property claim report by id
     *
     * @param  string $claim_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPropertyClaimReportByIdAsync($claim_id, $report_id)
    {
        return $this->getPropertyClaimReportByIdAsyncWithHttpInfo($claim_id, $report_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPropertyClaimReportByIdAsyncWithHttpInfo
     *
     * Get a property claim report by id
     *
     * @param  string $claim_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPropertyClaimReportByIdAsyncWithHttpInfo($claim_id, $report_id)
    {
        $returnType = '\Swagger\Client\Model\PropertyClaimReportsResponse';
        $request = $this->getPropertyClaimReportByIdRequest($claim_id, $report_id);
    ...
    /**
     * Create request for operation 'getPropertyClaimReportById'
     *
     * @param  string $claim_id (required)
     * @param  string $report_id (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPropertyClaimReportByIdRequest($claim_id, $report_id)
    {
        // verify the required parameter 'claim_id' is set
        if ($claim_id === null || (is_array($claim_id) && count($claim_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $claim_id when calling getPropertyClaimReportById'
            );
        }
        // verify the required parameter 'report_id' is set
        if ($report_id === null || (is_array($report_id) && count($report_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $report_id when calling getPropertyClaimReportById'
            );
        }

        $resourcePath = '/property/claim/{claim-id}/reports/{report-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getPropertyClaimReports
     *
     ...
     * @return \Swagger\Client\Model\PropertyClaimReportsResponse[]
     */
    public function getPropertyClaimReports($claim_id)
    {
        list($response) = $this->getPropertyClaimReportsWithHttpInfo($claim_id);
        return $response;
    }

    /**
     * Operation getPropertyClaimReportsWithHttpInfo
     *
     * Get property claim reports
     *
     * @param  string $claim_id (required)
     ...
     * @return array of \Swagger\Client\Model\PropertyClaimReportsResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getPropertyClaimReportsWithHttpInfo($claim_id)
    {
        $returnType = '\Swagger\Client\Model\PropertyClaimReportsResponse[]';
        $request = $this->getPropertyClaimReportsRequest($claim_id);
    ...
    /**
     * Operation getPropertyClaimReportsAsync
     *
     * Get property claim reports
     *
     * @param  string $claim_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPropertyClaimReportsAsync($claim_id)
    {
        return $this->getPropertyClaimReportsAsyncWithHttpInfo($claim_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPropertyClaimReportsAsyncWithHttpInfo
     *
     * Get property claim reports
     *
     * @param  string $claim_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPropertyClaimReportsAsyncWithHttpInfo($claim_id)
    {
        $returnType = '\Swagger\Client\Model\PropertyClaimReportsResponse[]';
        $request = $this->getPropertyClaimReportsRequest($claim_id);
    ...
    /**
     * Create request for operation 'getPropertyClaimReports'
     *
     * @param  string $claim_id (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPropertyClaimReportsRequest($claim_id)
    {
        // verify the required parameter 'claim_id' is set
        if ($claim_id === null || (is_array($claim_id) && count($claim_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $claim_id when calling getPropertyClaimReports'
            );
        }
